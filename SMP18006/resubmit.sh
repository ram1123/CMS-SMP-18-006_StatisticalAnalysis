...
#combine Example_test.root -M MultiDimFit -P hfs0  --floatOtherPOIs=0 --algo=grid --points=2000 --minimizerStrategy=1 -t -1 --expectSignal=1
...
#combine Example_test.root -M MultiDimFit -P hfs0 --floatOtherPOIs=0 --algo=grid --points=500 --minimizerStrategy=2 -t -1 --expectSignal=1
#python build1DInterval.py -${range} ${range} higgsCombineTest.MultiDimFit.mH120.root hfs0
...
combine Example_test.root -M MultiDimFit -P hfs0 --floatOtherPOIs=0 --algo=grid --points=2000 --minimizerStrategy=2 -t -1 --expectSignal=1
python build1DInterval.py -${range} ${range} higgsCombineTest.MultiDimFit.mH120.root hfs0
